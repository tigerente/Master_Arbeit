...
\begin{center}
    \begin{tabular}[h]{p{2cm}r@{\hspace{1cm}}l}
        ...
        \midrule
        $i_P$       &\SI{\Sexpr{r$i_P.MF}}{kg/kg} & \sourceM\\
        $i_N$       &\SI{\Sexpr{r$i_N.MF}}{kg/kg} & \sourceW, \sourceM, \sourceE\\
        $i_d$       &\SI{\Sexpr{r$i_d.MF}}{kg/kg} & \sourceM\\
        \midrule
        ...
        $m_S$           &\SI{\Sexpr{r$m_S}}{kg/kg} & \sourceS\\
        \midrule
        $p_\text{I}$    & \SI{\Sexpr{r$Ind.p}}{} & \sourceD \\
        $p_\text{II}$,
        $p_\text{III}$  & \SI{\Sexpr{r$Luh.p}}{} & \sourceE, \sourceD \\
        $d_\text{I}$,
        $d_\text{II}$   & \SI{\Sexpr{r$Luh.d}}{km} & \sourceD, \sourceE \\
