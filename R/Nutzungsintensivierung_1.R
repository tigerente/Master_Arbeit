...
plot(h_points, t_points, xlab = 'Nutzungshäufigkeit $h$ [1/Jahr]', ylab = 'Nutzungsdauer $t$ [Jahre]', type = 'p', pch = 22, bg = 'white', xlim = c(h_low, h_high), ylim = c(t_low, t_high), panel.first = points(h_lines, t_lines, type = 'l', lty = 2))
abline(v = n_max/t_max, lty = 3)
title('Nutzungsdauer $t(h)$', line = 4.5)
axis (side = 1, at = c(200, 400, 600, 800, n_max/t_max), labels = c(200, 400, 600, 800, '$h^*$'))
axis (side = 3, at = h_points, labels = p_points)
mtext ('parallele Produktanzahl $p$', side = 3, line = 2.5, cex = 0.66)

plot(h_points, n_points, xlab = 'Nutzungshäufigkeit $h$ [1/Jahr]', ylab = 'Nutzungsmenge $n$ [Nutzungseinheiten]', type = 'p', pch = 22, bg = 'white', xlim = c(h_low, h_high), ylim = c(n_low, n_high), panel.first = points(h_lines, n_lines, type = 'l', lty = 2))
abline(v = n_max/t_max, lty = 3)
...
plot(h_points, P_points, xlab = 'Nutzungshäufigkeit $h$ [1/Jahr]', ylab = 'Produktanzahl $P$ [Anzahl, anteilig]', type = 'p', pch = 22, bg = 'white', xlim = c(h_low, h_high), ylim = c(P_low, P_high), panel.first = points(h_lines, P_lines, type = 'l', lty = 2))
abline(v = n_max/t_max, lty = 3)
