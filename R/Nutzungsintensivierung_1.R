...
t_points = time(h_points, t_max, n_max)
...
t_lines = time(h_lines, t_max, n_max)
n_lines = n(h_lines, t_max, n_max)
P_lines = P(h_lines, t_max, n_max, N)

# Plots erzeugen:
par(mfcol=c(1,3), mar = c(6.1,4.1,6.5,2.1))
