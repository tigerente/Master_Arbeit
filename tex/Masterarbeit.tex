...
% END_FOLD
      ...
      In Abbildung \ref{fig:i_N(a)_MIPS(a)} wird deutlich, dass die Elastizitätsbedingung für kleine Produktauslastungen $a \leq a^*$ nicht notwendig für die Verringerung der MIPS ist: In beiden dargestellten Fällen sinken die MIPS für kleine $a$.
