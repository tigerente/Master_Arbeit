...
\documentclass[11pt, titlepage=true, twoside=true, BCOR=8mm]{scrreprt} % use larger type; default would be 10pt
...
\scriptsize A. Müller}
    ...
    \begin{table}
      ...
      MIPS unter einer marginalen Erhöhung der Wartungshäufigkeit sinken:
        ...
        diese Änderungen jedoch ab. Entsprechend verlaufen auch die MIPS: Für
