...
- Umweltverbrauch von Produkten
- gemeinschaftliche Produktnutzung wie z.B. Car Sharing oder Waschsalon als Möglichkeit, den Umweltverbrauch zu senken
- Scholl beschreibt eine Reihe positiver und negativer Umwelteffekte, die mit gemeinschaftlicher Produktnutzung einhergehen.
...
- Unter welchen Umständen kann der Umweltverbrauch insgesamt gesenkt werden?
- Dazu formalisieren wir eine Auswahl der von Scholl beschriebenen Umwelteffekte, indem wir den Einfluss der Faktoren Produktauslastung, Nutzungshäufigkeit, Wartung, Reparaturen und Transporte auf den Umweltverbrauch der Produktnutzung untersuchen. Wir gehen von der Hypothese aus, dass diese Faktoren bei der gemeinschaftlichen Produktnutzung im Vergleich zur herkömmlichen Produktnutzung erhöht sind.

% Methodik
% -Welche Methodik kommt im Text zum Einsatz? Welche empirische Basis geht dem Text voraus?
- Erstellen von mathematischen Modellen, die den Umweltverbrauch in Abhängigkeit von den genannten Faktoren quantifiziert.
- Operationalisierung des Umweltverbrauchs: MIPS-Konzept (Liedtke)
- Anwendung der Modelle zur Ableitung von Kriterien
- Fallstudie zur gemeinschaftlichen Waschmaschinen-Nutzung

% Ergebnisse
% - Welche Ergebnisse liefert der Text? Wie decken sich diese mit der Forschung in dem Themengebiet?
- Modelle für den Umweltverbrauch / MIPS von Produktnutzungssystemen zu den Faktoren ...
- Beantwortung der Fragestellung: Kriterien für die Senkung des Umweltverbrauchs (unter Berücksichtigung dieser Faktoren)
- Die Anwendbarkeit wird exemplarisch für zwei Modelle anhand einer Fallstudie zur Waschmaschinennutzung demonstriert.
- Ergebnis der Fallstudie: Zwar teilweise Kriterien-Erfüllung, aber nur sehr geringe Einsparung
...
- Primärer Zweck der Modelle: Kriterien-Entwicklung. Hier wird schnell eine Grenze erreicht.
- Ergebnisse der Fallstudie legen nahe, die Größenordnung der Einsparung näher in den Blick zu nehmen. Hierfür sind die Modelle auch anwendbar, aber nicht im Rahmen von Kriterien, sondern mit Fallstudien.
- Modellentwicklung hilfreich: Berechnungsvorschrift für konkrete Anwendungen, Systemverständnis / Systemvergleich
