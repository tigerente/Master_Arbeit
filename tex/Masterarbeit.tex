...
\begin{equation}
   \hat{d}(p^\text{herk}) = 
   \left\{ \begin{array}{ll}
      \frac{i_P}{\mathbb{T} \cdot A} \cdot \left( \frac{p^\text{herk} \cdot T}{N
...
\begin{equation}
    \text{MIPS}(h,d) = 
    \mathbb{T} \cdot d + \frac{I_{\text{fix}}^{h,d}}{S_D} + 
    \left\{ \begin{array}{ll}  
...
werden. Zum anderen muss die Größe $\mathbb{T}$ spezifiziert werden. Da wir im
...
$\mathbb{T} = A \cdot \theta \cdot i_d$ (vgl. die Modellanalyse im Modell
