...
In diesem Abschnitt werden ausgewählte Faktoren für den Umweltverbrauch eines Produktnutzungssystems, die im Zusammenhang mit gemeinschaftlicher Produktnutzung relevant sind, isoliert betrachtet. Wir beginnen mit dem Faktor \enquote{Nutzungshäufigkeit}.
    ...
    \begin{table}
      ...
      Nutzungseinheiten angibt.   Im Folgenden werden wir den Einfluss der
      Wartungshäufigkeit auf die MIPS formal beschreiben.
      ...
      \label{sec:WA}
        ...
        $I'_W \geq$ gilt. Zunächst sei der Ausdruck jedoch inhaltlich
        erläutert: Gemäß Modellannahmen führt eine Erhöhung der
        ...
        Inputs auf der anderen Seite.  Da diese drei Effekte nicht direkt
        miteinander wechselwirken, können sie auch in der marginalen Sichtweise separat
        ...
        Wartungshäufigkeit ab. Betrachten wir als letztes den Anstieg der
        produktbezogenen Inputs:
        \begin{align}
        ...
        Wartungshäufigkeit (vgl. Eigenschaft (i) in Gleichung \eqref{eq:Wartung_n_max}) dazu, dass je Produkt
        ...
        rechtsgekrümmt ist (vgl. Eigenschaft (ii) in Gleichung
        \eqref{eq:Wartung_i_N})
        erhalten wir für die Änderung des Betrags vom Anstieg $|I_P'(w)|$:
        \begin{align}
            |I'_P(w)|' &= \left\{ 
                \begin{array}{r@{\quad : \quad}l}
        ...
        \begin{align}
            ...
            \Leftrightarrow \quad & 
                               ...
                               \left\{ 
                                   ...
                                   \right.
        \end{align}
        Hier wurde bereits die Nutzungsmenge, die in allen Ableitungen enthalten
        ist, heraus gekürzt. 
        
        Werden Produkte vor Erreichen ihrer Lebensdauer entsorgt, also
        $\n{max}(w) \geq h\cdot\t{max}$ gilt, so nimmt
        ...
        nicht steigen, kann die Bedingung \eqref{eq:Wartung_Bedingung2}: 
        \begin{itemize}
