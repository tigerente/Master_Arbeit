...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \begin{itemize}
        \item  Radius R
        \item  Bevölkerungsdichte und Dichte der potentiellen Nutzer*innen
...
\section{Berechnungen / Ergebnisse}
% allgemeines Vorgehen beschreiben:
%   - zunächst Nutzungsintensivierung, dann Kopplung mit zusätzlichen Transporten
%   - jeweils Überprüfung der in dem Theorieteil aufgestellten Kriterien und zum
%   anderen werden die Daten verwendet um noch etwas mehr ins Detail zu gehen
%   (v.a. Größenordnung der MIPS)

\subsection{Nutzungsintensivierung}
%   Beschreiben, was bei der Nutzungsintensivierung geschieht:
%       1) aufgestelltes Kriterium aus der Theorie wird für das Fallbeispiel
%       überprüft
%       2) MIPS-Änderung in Abhängigkeit von der Produktanzahl im Zielszenario
%       anschauen

\subsubsection{Kriterienüberprüfung}
% - h*, p* berechnen für die verschiedenen Cases und mit h_Ind bzw. p_Ind
%   vergleichen
% - als Ergebnis formulieren: 10 Maschinen hättens auch getan
\input{Tabellen/NI_Kriterien.tex}
\subsubsection{Größenordnung der MIPS-Einsparung}
% - Graphik beschreiben (qualitativen Verlauf beschreiben und Bedeutung von p*
%   verdeutlichen)
% - jetzt quantitativ: MIPS-Einsparung ablesen für p_Gem (Average Case)
% - ja aber hängt halt von den Parametern ab: auf die Sensitivität der Parameter
%   eingehen
		\begin{figure}[ht]
		...
		\end{figure}
\subsection{Kopplung: Nutzungsintensivierung und zusätzliche Transporte}
