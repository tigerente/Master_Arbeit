...
%
      \begin{figure}[htp]
         ...
         \caption{Effektive Produktanzahl $P$ in Abhängigkeit von der Produktauslastung $a$. Bei $a^*$ wird der Nutzungsvorrat gerade innerhalb der Maximalnutzungsdauer aufgebraucht. Parameter: $I_\text{fix}$ = 10.000~kg, $S_D$ = 40.000~SE, $K$ = 10~SE/NE, $i_P$ = 5.000~kg, $T$ = 10~Jahre, $t_\text{max}$ = 15~Jahre, $n_\text{max}$ = 5.000~NE, $p$ = 2 (NE~=Nutzungseinheiten, SE~=~Service-Einheiten).}
         \label{fig:P(a)}
      \end{figure}
...
% END_FOLD
      ...
      \todo[color=prioH]{2x2 Abbildung $i_N(a)$ und MIPS(a) elastisch/unelastisch erstellen}
      ...
      \todo[color=prioM]{Bezug zu Abb.  $i_N(a)$ herstellen, z.B. Knick im Funktionsverlauf}
