...
Einerseits wurde herausgearbeitet, dass die Entwicklung von Kriterien zur Senkung des Umweltverbrauchs durch gemeinschaftliche Produktnutzungsformen an methodische Grenzen gestoßen ist. Hinzu kommt, dass die Überprüfung der Kriterien zwar Auskunft darüber gibt, ob  eine Senkung des Umweltverbrauchs erreicht werden kann, dabei jedoch keine Aussage über die ebenso relevante Größenordnung der Einsparung zulässt.

Andererseits wurde erörtert, dass die entwickelten Modelle sowohl zur Berechnung des Umweltverbrauchs konkreter Fallbeispiele, als auch zum Vergleich verschiedener Produktnutzungsformen sowie zur Ableitung von Handlungsempfehlungen eingesetzt werden können.
