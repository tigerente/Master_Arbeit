...
Arbeitspakete \enquote{\paketEins}, \enquote{\paketZwei}, \enquote{\paketDrei} und \enquote{\paketVier} einteilen. 
...
auch bearbeitet wurde, ist eine Fertigstellung dieses Arbeitspakets bereits bis Ende des
Jahres geplant.
...
Analysen der Einzelmodelle für die Modellkopplungen angepasst werden, die
...
Während der Vorlesungszeit (ab sofort bis Anfang Februar) planen wir im Umfang von ca. 20 Personenstunden pro
Woche an der Master-Arbeit zu arbeiten. Danach erhöht sich der Arbeitsumfang auf ca. 70 Personenstunden pro Woche. Zusammen mit dem geschätzten Aufwand je Arbeitspaket ergibt sich der voraussichtliche
Abschluss der Masterarbeit bis zum 31.05.2015 (vgl. Tabelle \ref{tab:zeitplan}).
Wir planen eine maximale Verzögerung des Projekts im Umfang von einem Drittel des
...
\begin{table}[h]
  ...
  \caption{Grobe Strukturierung der Master-Arbeit in vier Arbeitspakete mit
    Aufwandsschätzungen und Terminen.}
  \label{tab:zeitplan}
\end{table}
