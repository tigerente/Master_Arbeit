...
Das Hauptziel unserer Arbeit ist die Entwicklung von Kriterien für die ökologische Nachhaltigkeit gemeinschaftlicher Produktnutzung. Darunter fällt eine systematische und möglichst allgemeine Betrachtung der verschiedenen Umweltwirkungen von gemeinschaftlichen Nutzungsformen. Ein methodologisches Ziel der Arbeit ist es, einen einheitlichen Methodenrahmen für verschiedene Produkte und Nutzungssysteme zu entwickeln.

Unsere mit dem Forschungsziel korrespondierende Fragestellung lautet:
\begin{itemize}
	\item Unter welchen Umständen kann die Ressourceneffizienz eines Produktes durch gemeinschaftliche Nutzung gegenüber der individuellen Nutzung gesteigert werden?
\end{itemize}
Diese Fragestellung lässt sich in die folgenden zwei Teilfragen unterteilen:
\begin{itemize}
	\item Was sind die Mechanismen, die den Ressourcenverbrauch bei gemeinschaftlicher Nutzung bestimmen und wie wirken diese?
	\item Welche Eigenschaften des Produkts und der Nutzungsform bestimmen den Ressourcenverbrauch und wie fließen sie ein?
\end{itemize}
